...
<form id="mainForm" name="myForm" action="../Login&Register1/loginverify.php" method="post" >
...
<li><input type="submit" value="Login" class="login"  id="login-btn" name='login-btn' onclick="validate(0)"/></li>
</ul>
</div>
<div class="register forms hidden">
    ...
    <ul>
       ...
       <li><input type="text" id="name" class="login" size="40" name="register-username" placeholder="Name"/></li>
       ...
       <li><input type="submit"  id="login-btn" class="login" value="Register" name='register-btn'  onclick="validate(1)"/></li>
    </ul>
</div>
</form>
</div>
